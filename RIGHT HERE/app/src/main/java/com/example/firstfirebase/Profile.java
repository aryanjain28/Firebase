...
public class Profile extends AppCompatActivity {
    ...
    private static int SET_BUTTON =0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (bundle == null) {
            findViewById(R.id.backImage).setVisibility(View.VISIBLE);
            findViewById(R.id.backMessage).setVisibility(View.VISIBLE);

            findViewById(R.id.welcomeText).setVisibility(View.INVISIBLE);
            findViewById(R.id.welcomeButton).setVisibility(View.INVISIBLE);
            findViewById(R.id.welcomeButton).setEnabled(false);
            findViewById(R.id.welcomeButton).setClickable(false);
        }
        else {
            findViewById(R.id.backImage).setVisibility(View.INVISIBLE);
            findViewById(R.id.backMessage).setVisibility(View.INVISIBLE);
            ...
            findViewById(R.id.welcomeButton).setClickable(true);
        }
    ...
    public void enterWelcomeActivity(View view) {
        if (!name.getText().toString().trim().equals("") && !number.getText().toString().trim().equals("")) {
                ...
                Toast.makeText(Profile.this, "Please enter details.", Toast.LENGTH_SHORT).show();
            }
    }
}
